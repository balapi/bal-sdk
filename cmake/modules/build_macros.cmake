...
macro(_bcm_strip_install TARGET INSTALL_DIR)
    ...
    if("${SUBSYSTEM}" STREQUAL "host")
        install(PROGRAMS ${CMAKE_CURRENT_BINARY_DIR}/strip/$<TARGET_FILE_NAME:${TARGET}> DESTINATION ${INSTALL_DIR})
...
macro(_bcm_module_add_header_validation)
    if(${BCM_VALIDATE_HDRS})
        ...
        foreach(_DIR ${_MOD_PRIVATE_HDR} ${_MOD_PUBLIC_HDR})
            file(GLOB _GLOB RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} ${_DIR}/*.h)
            list(APPEND _HDRS ${_GLOB})
        endforeach(_DIR)
        if(DEFINED _HDRS)
