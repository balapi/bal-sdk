...
{
    obj->plid = BCMOLT_IEEE_DEMO_ONU_LLID_RATE_DISABLE;
    obj->mlid = BCMOLT_IEEE_DEMO_ONU_LLID_RATE_DISABLE;
    obj->bcast_plid = BCMOLT_IEEE_DEMO_ONU_LLID_RATE_DISABLE;
    obj->bcast_mlid = BCMOLT_IEEE_DEMO_ONU_LLID_RATE_DISABLE;
