 ...
 * \param[in]  err_buf Char buffer in which to write a string detailing the error if an error is returned.
 *                     This can be NULL, in which case no error details will be returned.
