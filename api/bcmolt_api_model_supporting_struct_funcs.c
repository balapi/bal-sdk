...
{
    obj->presence_mask = 0;
    obj->intf_type = BCMOLT_INTERFACE_TYPE_PON;
    obj->intf_id = (bcmolt_interface_id)0;
...
bcmos_bool bcmolt_channel_profile_validate(const bcmolt_channel_profile *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->default_onu_attenuation can't be invalid. */
    }
...
{
    obj->presence_mask = 0;
    obj->sched_id = (bcmolt_tm_sched_id)0U;
    obj->queue_id = (bcmolt_tm_queue_id)0U;
}
...
void bcmolt_xgpon_burst_profile_set_default(bcmolt_xgpon_burst_profile *obj)
{
    ...
    obj->delimiter_pattern_low = 0x0UL;
    obj->preamble_length_in_bytes = 0;
...
bcmos_bool bcmolt_xgpon_burst_profile_validate(const bcmolt_xgpon_burst_profile *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->delimiter_size_in_bytes can't be invalid. */
    }
    ...
    {
        /* obj->preamble_length_in_bytes can't be invalid. */
    }
...
void bcmolt_classifier_ip_v_6_set_default(bcmolt_classifier_ip_v_6 *obj)
{
    ...
    bcmos_ipv6_address_init(&obj->dst_ip_v_6_mask);
    bcmos_ipv6_address_init(&obj->src_ip_v_6);
    bcmos_ipv6_address_init(&obj->src_ip_v_6_mask);
...
bcmos_bool bcmolt_debug_flow_config_validate(const bcmolt_debug_flow_config *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->untagged_vid can't be invalid. */
    }
    return BCMOS_TRUE;
}
...
{
    obj->presence_mask = 0;
    obj->type = BCMOLT_EGRESS_QOS_TYPE_FIXED_QUEUE;
    bcmolt_tm_sched_ref_set_default(&obj->tm_sched);
    obj->u.fixed_queue.presence_mask = 0;
    obj->u.fixed_queue.queue_id = (bcmolt_tm_queue_id)0U;
}
...
void bcmolt_egress_qos_set_union_default(bcmolt_egress_qos *obj, bcmolt_egress_qos_type type)
{
    ...
    case BCMOLT_EGRESS_QOS_TYPE_PRIORITY_TO_QUEUE:
        ...
        obj->u.priority_to_queue.tm_qmp_id = (bcmolt_tm_qmp_id)0;
        obj->u.priority_to_queue.tm_q_set_id = (bcmolt_tm_queue_set_id)0U;
        break;
...
bcmos_bool bcmolt_egress_qos_validate(const bcmolt_egress_qos *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    case BCMOLT_EGRESS_QOS_TYPE_TC_TO_QUEUE:
    {
        ...
        {
            /* obj->u.tc_to_queue.tc_id can't be invalid. */
        }
    ...
    case BCMOLT_EGRESS_QOS_TYPE_PRIORITY_TO_QUEUE:
    {
        ...
        {
            /* obj->u.priority_to_queue.tm_qmp_id can't be invalid. */
        }
...
{
    obj->presence_mask = 0;
    obj->intf_type = (bcmolt_flow_interface_type)0;
    obj->intf_id = (bcmolt_interface_id)0;
}
...
void bcmolt_gpon_onu_params_set_default(bcmolt_gpon_onu_params *obj)
{
    ...
    obj->omci_port_id = (bcmolt_gem_port_id)0UL;
...
{
    obj->presence_mask = 0;
    obj->pls_maximum_allocation_size = 0UL;
    obj->mode = 0;
}
...
void bcmolt_gpon_pon_params_set_default(bcmolt_gpon_pon_params *obj)
{
    ...
    obj->bip32_indication_control = BCMOLT_CONTROL_STATE_DISABLE;
    obj->ds_ber_reporting_interval = (bcmolt_ber_interval)0UL;
    obj->sr_reporting_block_size = 0;
}
...
bcmos_bool bcmolt_gpon_pon_params_validate(const bcmolt_gpon_pon_params *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->preassigned_equalization_delay can't be invalid. */
    }
...
{
    obj->presence_mask = 0;
    obj->transceiver_type = BCMOLT_TRX_TYPE_SPS_43_48_H_HP_CDE_SD_2013;
}
...
void bcmolt_inni_config_set_default(bcmolt_inni_config *obj)
{
    ...
    obj->ps_gpio = BCMOLT_GPIO_PIN_PIN0;
...
{
    obj->presence_mask = 0;
    obj->drift_interval = 0UL;
    obj->drift_limit = 0;
    obj->transmission_control_limit = 0;
}
...
void bcmolt_onu_activation_set_default(bcmolt_onu_activation *obj)
{
    ...
    obj->authentication = BCMOLT_CONTROL_STATE_DISABLE;
    obj->fail_due_to_authentication_failure = BCMOLT_CONTROL_STATE_DISABLE;
}
...
void bcmolt_itupon_protection_switching_set_default(bcmolt_itupon_protection_switching *obj)
{
    obj->presence_mask = 0;
    obj->timeout = 0U;
    obj->gpio_pin = BCMOLT_GPIO_PIN_PIN0;
    obj->ps_c_wait_before_deactivation_timeout = 0U;
...
{
    obj->presence_mask = 0;
    obj->response_timeout_ms = 0UL;
    obj->max_retry_count = 0;
    obj->omci_format = (bcmolt_omci_device_id)0;
    obj->window_size = 0U;
    obj->activate_commit = BCMOS_FALSE;
    obj->delay_for_commit_ms = 0UL;
    obj->max_activation_attempts = 0;
    obj->end_swdl_delay_ms = 0UL;
}
...
bcmos_bool bcmolt_ituonu_upgrade_params_validate(const bcmolt_ituonu_upgrade_params *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->response_timeout_ms can't be invalid. */
    }
    ...
    {
        /* obj->window_size can't be invalid. */
    }
    ...
    {
        /* obj->delay_for_commit_ms can't be invalid. */
    }
    ...
    {
        /* obj->end_swdl_delay_ms can't be invalid. */
    }
    return BCMOS_TRUE;
}
...
void bcmolt_onu_tuning_configuration_set_default(bcmolt_onu_tuning_configuration *obj)
{
    ...
    obj->tsource = 0UL;
    obj->ttarget = 0UL;
    obj->request_registration_required = BCMOS_FALSE;
}
...
void bcmolt_operation_control_set_default(bcmolt_operation_control *obj)
{
    ...
    obj->ds_fec_mode = BCMOLT_CONTROL_STATE_DISABLE;
    obj->protocol = BCMOLT_TC_PROTOCOL_TC_LAYER_PROTOCOL_G_987_P_3;
...
bcmos_bool bcmolt_periodic_ploams_validate(const bcmolt_periodic_ploams *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->interval_ms can't be invalid. */
    }
    return BCMOS_TRUE;
}
...
void bcmolt_xgpon_pon_params_set_default(bcmolt_xgpon_pon_params *obj)
{
    ...
    obj->min_data_gem_port_id = (bcmolt_gem_port_id)0UL;
...
bcmos_bool bcmolt_xgpon_pon_params_validate(const bcmolt_xgpon_pon_params *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->min_data_gem_port_id can't be invalid. */
    }
...
void bcmolt_itu_pon_params_set_default(bcmolt_itu_pon_params *obj)
{
    ...
    obj->min_data_alloc_id = (bcmolt_alloc_id)0U;
...
bcmos_bool bcmolt_itu_pon_params_validate(const bcmolt_itu_pon_params *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->eqd_cycles_number can't be invalid. */
    }
    ...
    {
        /* obj->min_data_alloc_id can't be invalid. */
    }
...
void bcmolt_itu_tod_set_default(bcmolt_itu_tod *obj)
{
    ...
    obj->tod_gpio_pin = BCMOLT_GPIO_PIN_PIN0;
    obj->connected_internally = BCMOS_FALSE;
    obj->tod_string_length = 0;
}
...
bcmos_bool bcmolt_itu_tod_validate(const bcmolt_itu_tod *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->tod_string_length can't be invalid. */
    }
    return BCMOS_TRUE;
}
...
{
    obj->presence_mask = 0;
    obj->polynomial = (bcmolt_lag_hash_polynomial)0;
    obj->hash_field = (bcmolt_lag_hash_field_flags)0UL;
}
...
{
    obj->presence_mask = 0;
    obj->id = (bcmolt_mep_id)0U;
    obj->interval = (bcmolt_ccm_interval)0UL;
...
void bcmolt_meg_cfg_set_default(bcmolt_meg_cfg *obj)
{
    ...
    obj->format = (bcmolt_meg_format)0;
    obj->level = BCMOLT_MEG_LEVEL_LEVEL_0;
}
...
{
    obj->presence_mask = 0;
    obj->host_dma_rx_queue_size = 0U;
    obj->host_dma_tx_queue_size = 0U;
    obj->mtu = (bcmolt_mtu)0UL;
...
{
    obj->presence_mask = 0;
    obj->max_log_distance = 0UL;
    obj->max_diff_reach = 0UL;
}
...
void bcmolt_remote_mep_set_default(bcmolt_remote_mep *obj)
{
    obj->presence_mask = 0;
    obj->id = (bcmolt_mep_id)0U;
    obj->loc_clear_threshold = (bcmolt_loc_clear_threshold)0UL;
    obj->state = BCMOLT_CONTROL_STATE_DISABLE;
}
...
bcmos_bool bcmolt_service_discovery_validate(const bcmolt_service_discovery *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->burst_profile can't be invalid. */
    }
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_system_profile_validate(const bcmolt_system_profile *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    {
        /* obj->ng_2_sys_id can't be invalid. */
    }
    ...
    {
        /* obj->channel_spacing can't be invalid. */
    }
    ...
    {
        /* obj->twdm_channel_count can't be invalid. */
    }
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_param_validate(const bcmolt_tm_sched_param *obj, bcmos_errno *err, bcmolt_string *err_details)
{
    ...
    case BCMOLT_TM_SCHED_PARAM_TYPE_WEIGHT:
    {
        ...
        {
            /* obj->u.weight.weight can't be invalid. */
        }
        break;
    }
    default:
...
void bcmolt_trap_config_set_default(bcmolt_trap_config *obj)
{
    ...
    obj->vlan_mask = (bcmolt_vlan_id)0U;
    obj->cfi = 0;
    obj->pbits = 0;
