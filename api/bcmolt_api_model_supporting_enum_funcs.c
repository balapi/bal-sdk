...
bcmos_bool bcmolt_access_control_fwd_action_type_unpack(
    bcmolt_access_control_fwd_action_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    ...
    *p_obj = (bcmolt_access_control_fwd_action_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_action_cmd_id_pack(
    ...
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u32(p_buf, (uint32_t)obj);
}

bcmos_bool bcmolt_action_cmd_id_unpack(
    bcmolt_action_cmd_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint32_t num_val;
    if (!bcmolt_buf_read_u32(p_buf, &num_val))
    {
        return BCMOS_FALSE;
    }
    *p_obj = (bcmolt_action_cmd_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_action_control_pkt_modifiers_unpack(
    bcmolt_action_control_pkt_modifiers *p_obj,
    bcmolt_buf *p_buf)
{
    uint32_t num_val;
    if (!bcmolt_buf_read_u32(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_action_control_pkt_modifiers)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_action_tag_format_unpack(
    bcmolt_action_tag_format *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_action_tag_format)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_activation_fail_reason_unpack(
    bcmolt_activation_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_activation_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_activation_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_active_interface)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_additional_bw_eligibility_unpack(
    bcmolt_additional_bw_eligibility *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_additional_bw_eligibility)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_alloc_operation)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_alloc_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_automatic_onu_deactivation_reason_unpack(
    bcmolt_automatic_onu_deactivation_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_automatic_onu_deactivation_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_bal_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_bal_state)num_val;
    return BCMOS_TRUE;
}

bcmos_bool bcmolt_bc_fwrd_state_pack(
    bcmolt_bc_fwrd_state obj,
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u8(p_buf, (uint8_t)obj);
}

bcmos_bool bcmolt_bc_fwrd_state_unpack(
    bcmolt_bc_fwrd_state *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_bc_fwrd_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_binding_command)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_burst_profile_type_unpack(
    bcmolt_burst_profile_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_burst_profile_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_calibration_record_unpack(
    bcmolt_calibration_record *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_calibration_record)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ccm_event)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ccm_interval)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_chip_family)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_comm_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_config_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_control_state)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_dba_implementation_type_unpack(
    bcmolt_dba_implementation_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_dba_implementation_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_dba_options)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ddr_test_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ddr_test_result)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ddr_test_status)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_deactivation_fail_reason_unpack(
    bcmolt_deactivation_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_deactivation_fail_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_chip_revision_unpack(
    bcmolt_device_chip_revision *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_chip_revision)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_disconnect_reason_unpack(
    bcmolt_device_disconnect_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_disconnect_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_image_type_unpack(
    bcmolt_device_image_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_image_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_disable_serial_number_control_unpack(
    bcmolt_disable_serial_number_control *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_disable_serial_number_control)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_duplex_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_egress_qos_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_embedded_image_transfer_status_unpack(
    bcmolt_embedded_image_transfer_status *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_embedded_image_transfer_status)num_val;
    return BCMOS_TRUE;
}

bcmos_bool bcmolt_enqueue_algorithm_pack(
    bcmolt_enqueue_algorithm obj,
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u8(p_buf, (uint8_t)obj);
}

bcmos_bool bcmolt_enqueue_algorithm_unpack(
    bcmolt_enqueue_algorithm *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_enqueue_algorithm)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_erps_control)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_erps_port)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_external_dba_options_unpack(
    bcmolt_external_dba_options *p_obj,
    bcmolt_buf *p_buf)
{
    uint32_t num_val;
    if (!bcmolt_buf_read_u32(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_external_dba_options)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_flow_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_flow_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_frequency_adjustment_direction_unpack(
    bcmolt_frequency_adjustment_direction *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_frequency_adjustment_direction)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gem_port_direction_unpack(
    bcmolt_gem_port_direction *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gem_port_direction)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gem_port_operation_unpack(
    bcmolt_gem_port_operation *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gem_port_operation)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gem_port_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gpio_pin_dir)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gpio_polarity)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gpio_value)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gpon_key_exchange_mode_unpack(
    bcmolt_gpon_key_exchange_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gpon_key_exchange_mode)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_member_update_fail_reason_unpack(
    bcmolt_group_member_update_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_member_update_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_group_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_group_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_connection_fail_reason_unpack(
    bcmolt_host_connection_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_connection_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_host_log_file_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_image_transfer_status_unpack(
    bcmolt_image_transfer_status *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_image_transfer_status)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_inband_mgmt_action_type_unpack(
    bcmolt_inband_mgmt_action_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_inband_mgmt_action_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_inband_mgmt_state_unpack(
    bcmolt_inband_mgmt_state *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_inband_mgmt_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_inject_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_inni_fec_modes)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_inni_lanes)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_interface_operation_unpack(
    bcmolt_interface_operation *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_interface_operation)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_interface_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_interface_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_redundancy_unpack(
    bcmolt_internal_nni_redundancy *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_redundancy)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_l2_dump_mode)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_event_report_control_unpack(
    bcmolt_l2_event_report_control *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_event_report_control)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mact_dump_status_unpack(
    bcmolt_l2_mact_dump_status *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mact_dump_status)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_hash_field_flags_unpack(
    bcmolt_lag_hash_field_flags *p_obj,
    bcmolt_buf *p_buf)
{
    uint32_t num_val;
    if (!bcmolt_buf_read_u32(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_hash_field_flags)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_hash_polynomial_unpack(
    bcmolt_lag_hash_polynomial *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_hash_polynomial)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_lag_health)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_member_update_fail_reason_unpack(
    bcmolt_lag_member_update_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_member_update_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_lag_psc_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_lag_subtype)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_link_fault_code)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_link_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_link_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_loc_clear_threshold_unpack(
    bcmolt_loc_clear_threshold *p_obj,
    bcmolt_buf *p_buf)
{
    uint32_t num_val;
    if (!bcmolt_buf_read_u32(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_loc_clear_threshold)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_log_file_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_log_level)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_log_style)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_mac_table_miss_action_unpack(
    bcmolt_mac_table_miss_action *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_mac_table_miss_action)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_meg_format)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_meg_level)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_members_update_command_unpack(
    bcmolt_members_update_command *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_members_update_command)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_mpcp_discovery_info_unpack(
    bcmolt_mpcp_discovery_info *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_mpcp_discovery_info)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_nni_connection)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_loopback_type_unpack(
    bcmolt_nni_loopback_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_loopback_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_protection_mode_unpack(
    bcmolt_nni_protection_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_protection_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_nni_subtype)num_val;
    return BCMOS_TRUE;
}

bcmos_bool bcmolt_nto1_programming_mode_pack(
    bcmolt_nto1_programming_mode obj,
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u8(p_buf, (uint8_t)obj);
}

bcmos_bool bcmolt_nto1_programming_mode_unpack(
    bcmolt_nto1_programming_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nto1_programming_mode)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_num_of_frames_per_map_unpack(
    bcmolt_num_of_frames_per_map *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_num_of_frames_per_map)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_odn_class)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_omci_device_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_omci_port_id_operation_unpack(
    bcmolt_omci_port_id_operation *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_omci_port_id_operation)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_operation)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_post_discovery_mode_unpack(
    bcmolt_onu_post_discovery_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_post_discovery_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_state)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_tuning_range_mode_unpack(
    bcmolt_onu_tuning_range_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_tuning_range_mode)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_upgrade_status_code_unpack(
    bcmolt_onu_upgrade_status_code *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_upgrade_status_code)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_packet_injection_error_unpack(
    bcmolt_packet_injection_error *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_packet_injection_error)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_packet_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_password_authentication_fail_reason_unpack(
    bcmolt_password_authentication_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_password_authentication_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_pkt_tag_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_policer_reference_type_unpack(
    bcmolt_policer_reference_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_policer_reference_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_policer_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_ni_onu_upgrade_status_code_unpack(
    bcmolt_pon_ni_onu_upgrade_status_code *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_ni_onu_upgrade_status_code)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_protection_switching_options_unpack(
    bcmolt_pon_protection_switching_options *p_obj,
    bcmolt_buf *p_buf)
{
    uint32_t num_val;
    if (!bcmolt_buf_read_u32(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_protection_switching_options)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_port_command)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_power_levelling_control_unpack(
    bcmolt_power_levelling_control *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_power_levelling_control)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_power_management_transition_reason_unpack(
    bcmolt_power_management_transition_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_power_management_transition_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_prbs_checker_mode_unpack(
    bcmolt_prbs_checker_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_prbs_checker_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_prbs_lock_state)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_prbs_polynomial)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_prbs_test_status_type_unpack(
    bcmolt_prbs_test_status_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_prbs_test_status_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ranging_fail_reason_unpack(
    bcmolt_ranging_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ranging_fail_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ras_ddr_usage_mode_unpack(
    bcmolt_ras_ddr_usage_mode *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ras_ddr_usage_mode)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_request_registration_fail_reason_unpack(
    bcmolt_request_registration_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_request_registration_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_reset_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ring_port)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ring_port_state)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_rssi_measurement_fail_reason_unpack(
    bcmolt_rssi_measurement_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_rssi_measurement_fail_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_secure_mutual_authentication_fail_reason_unpack(
    bcmolt_secure_mutual_authentication_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_secure_mutual_authentication_fail_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_src_binding_fields_unpack(
    bcmolt_src_binding_fields *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_src_binding_fields)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_src_binding_id_pack(
    ...
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_s32(p_buf, (int32_t)obj);
}

bcmos_bool bcmolt_src_binding_id_unpack(
    bcmolt_src_binding_id *p_obj,
    bcmolt_buf *p_buf)
{
    int32_t num_val;
    if (!bcmolt_buf_read_s32(p_buf, &num_val))
    {
        return BCMOS_FALSE;
    }
    *p_obj = (bcmolt_src_binding_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_condition_type_unpack(
    bcmolt_stat_condition_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_condition_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_sw_error_severity_unpack(
    bcmolt_sw_error_severity *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_sw_error_severity)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_over_type_c_onu_state_unpack(
    bcmolt_switch_over_type_c_onu_state *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_over_type_c_onu_state)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_pon_type_fail_reason_unpack(
    bcmolt_switch_pon_type_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_pon_type_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_system_mode)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tc_protocol)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_qmp_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_sched_dir)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_output_type_unpack(
    bcmolt_tm_sched_output_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_output_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_param_type_unpack(
    bcmolt_tm_sched_param_type *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_param_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_sched_type)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tod_calibration_fail_reason_unpack(
    bcmolt_tod_calibration_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tod_calibration_fail_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_traffic_resume_result_unpack(
    bcmolt_traffic_resume_result *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_traffic_resume_result)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_traffic_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_trivalent)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tune_in_fail_reason_unpack(
    bcmolt_tune_in_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tune_in_fail_reason)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tune_out_fail_reason_unpack(
    bcmolt_tune_out_fail_reason *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tune_out_fail_reason)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_uart_baudrate)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_um_fwrd_state)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_upstream_line_rate_capabilities_unpack(
    bcmolt_upstream_line_rate_capabilities *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_upstream_line_rate_capabilities)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_us_gem_port_destination_unpack(
    bcmolt_us_gem_port_destination *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_us_gem_port_destination)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_us_operating_wavelength_bands_unpack(
    bcmolt_us_operating_wavelength_bands *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_us_operating_wavelength_bands)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_xgpon_trx_type)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_api_group_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_stat_subgroup_unpack(
    bcmolt_access_control_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_stat_cfg_subgroup_unpack(
    bcmolt_access_control_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_auto_subgroup_unpack(
    bcmolt_access_control_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_oper_subgroup_unpack(
    bcmolt_access_control_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_auto_subgroup_unpack(
    bcmolt_device_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_oper_subgroup_unpack(
    bcmolt_device_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_auto_subgroup_unpack(
    bcmolt_erps_interface_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_oper_subgroup_unpack(
    bcmolt_erps_interface_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_stat_subgroup_unpack(
    bcmolt_eth_oam_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_stat_cfg_subgroup_unpack(
    bcmolt_eth_oam_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_auto_subgroup_unpack(
    bcmolt_eth_oam_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_oper_subgroup_unpack(
    bcmolt_eth_oam_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_stat_subgroup_unpack(
    bcmolt_flow_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_stat_cfg_subgroup_unpack(
    bcmolt_flow_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_auto_subgroup_unpack(
    bcmolt_flow_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_oper_subgroup_unpack(
    bcmolt_flow_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_auto_subgroup_unpack(
    bcmolt_group_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_oper_subgroup_unpack(
    bcmolt_group_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_log_file_oper_subgroup_unpack(
    bcmolt_host_log_file_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_log_file_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_stat_subgroup_unpack(
    bcmolt_internal_nni_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_stat_cfg_subgroup_unpack(
    bcmolt_internal_nni_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_auto_subgroup_unpack(
    bcmolt_internal_nni_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_oper_subgroup_unpack(
    bcmolt_internal_nni_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_stat_subgroup_unpack(
    bcmolt_itupon_alloc_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_stat_cfg_subgroup_unpack(
    bcmolt_itupon_alloc_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_auto_subgroup_unpack(
    bcmolt_itupon_alloc_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_oper_subgroup_unpack(
    bcmolt_itupon_alloc_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_stat_subgroup_unpack(
    bcmolt_itupon_gem_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_stat_cfg_subgroup_unpack(
    bcmolt_itupon_gem_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_auto_subgroup_unpack(
    bcmolt_itupon_gem_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_oper_subgroup_unpack(
    bcmolt_itupon_gem_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_auto_subgroup_unpack(
    bcmolt_l2_mac_table_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_oper_subgroup_unpack(
    bcmolt_l2_mac_table_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_stat_subgroup_unpack(
    bcmolt_lag_interface_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_stat_cfg_subgroup_unpack(
    bcmolt_lag_interface_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_auto_subgroup_unpack(
    bcmolt_lag_interface_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_oper_subgroup_unpack(
    bcmolt_lag_interface_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_log_file_oper_subgroup_unpack(
    bcmolt_log_file_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_log_file_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_stat_subgroup_unpack(
    bcmolt_nni_interface_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_stat_cfg_subgroup_unpack(
    bcmolt_nni_interface_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_auto_subgroup_unpack(
    bcmolt_nni_interface_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_oper_subgroup_unpack(
    bcmolt_nni_interface_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_olt_auto_subgroup_unpack(
    bcmolt_olt_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_olt_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_olt_oper_subgroup_unpack(
    bcmolt_olt_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_olt_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_stat_subgroup_unpack(
    bcmolt_onu_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_stat_cfg_subgroup_unpack(
    bcmolt_onu_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_auto_subgroup_unpack(
    bcmolt_onu_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_oper_subgroup_unpack(
    bcmolt_onu_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_stat_subgroup_unpack(
    bcmolt_pon_interface_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_stat_cfg_subgroup_unpack(
    bcmolt_pon_interface_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_auto_subgroup_unpack(
    bcmolt_pon_interface_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_oper_subgroup_unpack(
    bcmolt_pon_interface_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_interface_auto_subgroup_unpack(
    bcmolt_protection_interface_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_interface_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_interface_oper_subgroup_unpack(
    bcmolt_protection_interface_oper_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_interface_oper_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_stat_subgroup_unpack(
    bcmolt_switch_inni_stat_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_stat_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_stat_cfg_subgroup_unpack(
    bcmolt_switch_inni_stat_cfg_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_stat_cfg_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_auto_subgroup_unpack(
    bcmolt_switch_inni_auto_subgroup *p_obj,
    bcmolt_buf *p_buf)
{
    uint16_t num_val;
    if (!bcmolt_buf_read_u16(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_auto_subgroup)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_fwd_action_id_unpack(
    bcmolt_access_control_fwd_action_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_fwd_action_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_pkt_modifier_id_unpack(
    bcmolt_access_control_pkt_modifier_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_pkt_modifier_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_action_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_aes_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_automatic_onu_deactivation_id_unpack(
    bcmolt_automatic_onu_deactivation_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_automatic_onu_deactivation_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ber_monitor_params_id_unpack(
    bcmolt_ber_monitor_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ber_monitor_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_cbr_rt_allocation_profile_id_unpack(
    bcmolt_cbr_rt_allocation_profile_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_cbr_rt_allocation_profile_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_channel_profile_id_unpack(
    bcmolt_channel_profile_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_channel_profile_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_classifier_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_classifier_ip_v_6_id_unpack(
    bcmolt_classifier_ip_v_6_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_classifier_ip_v_6_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ddr_test_completed_id_unpack(
    bcmolt_ddr_test_completed_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ddr_test_completed_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ddr_test_completed_default_id_unpack(
    bcmolt_ddr_test_completed_default_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ddr_test_completed_default_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ddr_test_completed_completed_id_unpack(
    bcmolt_ddr_test_completed_completed_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ddr_test_completed_completed_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ddr_test_completed_connection_failed_id_unpack(
    bcmolt_ddr_test_completed_connection_failed_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ddr_test_completed_connection_failed_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_debug_device_cfg_id_unpack(
    bcmolt_debug_device_cfg_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_debug_device_cfg_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_debug_flow_config_id_unpack(
    bcmolt_debug_flow_config_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_debug_flow_config_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ds_frequency_offset_id_unpack(
    bcmolt_ds_frequency_offset_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ds_frequency_offset_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_egress_qos_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_egress_qos_fixed_queue_id_unpack(
    bcmolt_egress_qos_fixed_queue_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_egress_qos_fixed_queue_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_egress_qos_tc_to_queue_id_unpack(
    bcmolt_egress_qos_tc_to_queue_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_egress_qos_tc_to_queue_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_egress_qos_pbit_to_tc_id_unpack(
    bcmolt_egress_qos_pbit_to_tc_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_egress_qos_pbit_to_tc_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_egress_qos_priority_to_queue_id_unpack(
    bcmolt_egress_qos_priority_to_queue_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_egress_qos_priority_to_queue_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_egress_qos_none_id_unpack(
    bcmolt_egress_qos_none_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_egress_qos_none_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_embedded_image_entry_id_unpack(
    bcmolt_embedded_image_entry_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_embedded_image_entry_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_erps_intf_ref_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_extended_dba_priority_adjustment_id_unpack(
    bcmolt_extended_dba_priority_adjustment_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_extended_dba_priority_adjustment_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_firmware_sw_version_id_unpack(
    bcmolt_firmware_sw_version_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_firmware_sw_version_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gem_port_configuration_id_unpack(
    bcmolt_gem_port_configuration_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gem_port_configuration_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gpon_onu_alarm_state_id_unpack(
    bcmolt_gpon_onu_alarm_state_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gpon_onu_alarm_state_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gpon_onu_alarms_id_unpack(
    bcmolt_gpon_onu_alarms_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gpon_onu_alarms_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gpon_onu_alarms_thresholds_id_unpack(
    bcmolt_gpon_onu_alarms_thresholds_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gpon_onu_alarms_thresholds_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gpon_onu_params_id_unpack(
    bcmolt_gpon_onu_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gpon_onu_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_gpon_pon_params_id_unpack(
    bcmolt_gpon_pon_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_gpon_pon_params_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gpon_trx_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_member_info_id_unpack(
    bcmolt_group_member_info_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_member_info_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_members_update_command_id_unpack(
    bcmolt_group_members_update_command_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_members_update_command_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_port_params_id_unpack(
    bcmolt_host_port_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_port_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_sw_version_id_unpack(
    bcmolt_host_sw_version_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_sw_version_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_hw_pon_id_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ieee_8021_as_tod_id_unpack(
    bcmolt_ieee_8021_as_tod_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ieee_8021_as_tod_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_inband_config_data_id_unpack(
    bcmolt_inband_config_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_inband_config_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_inband_conn_data_id_unpack(
    bcmolt_inband_conn_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_inband_conn_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_indication_shaping_id_unpack(
    bcmolt_indication_shaping_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_indication_shaping_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_inni_config_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_intf_ref_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ip_v_4_src_binding_id_unpack(
    bcmolt_ip_v_4_src_binding_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ip_v_4_src_binding_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ip_v_6_src_binding_id_unpack(
    bcmolt_ip_v_6_src_binding_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ip_v_6_src_binding_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itu_onu_params_id_unpack(
    bcmolt_itu_onu_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itu_onu_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itu_pon_params_id_unpack(
    bcmolt_itu_pon_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itu_pon_params_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_itu_tod_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ituonu_upgrade_params_id_unpack(
    bcmolt_ituonu_upgrade_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ituonu_upgrade_params_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_itupon_dba_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_onu_aes_key_id_unpack(
    bcmolt_itupon_onu_aes_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_onu_aes_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_onu_eqd_id_unpack(
    bcmolt_itupon_onu_eqd_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_onu_eqd_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_protection_switching_id_unpack(
    bcmolt_itupon_protection_switching_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_protection_switching_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_key_exchange_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_dump_filters_id_unpack(
    bcmolt_l2_dump_filters_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_dump_filters_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_l2_mact_entry_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_global_parms_id_unpack(
    bcmolt_lag_global_parms_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_global_parms_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_members_update_command_id_unpack(
    bcmolt_lag_interface_members_update_command_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_members_update_command_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_layer_4_port_range_id_unpack(
    bcmolt_layer_4_port_range_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_layer_4_port_range_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_local_mep_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_log_level_msg_count_id_unpack(
    bcmolt_log_level_msg_count_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_log_level_msg_count_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_log_level_per_file_id_unpack(
    bcmolt_log_level_per_file_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_log_level_per_file_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_meg_cfg_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_mirror_action_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ngpon2_onu_params_id_unpack(
    bcmolt_ngpon2_onu_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ngpon2_onu_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ngpon2_pon_params_id_unpack(
    bcmolt_ngpon2_pon_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ngpon2_pon_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_link_status_id_unpack(
    bcmolt_nni_link_status_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_link_status_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_activation_id_unpack(
    bcmolt_onu_activation_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_activation_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_power_management_configuration_id_unpack(
    bcmolt_onu_power_management_configuration_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_power_management_configuration_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_ps_type_w_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_tuning_configuration_id_unpack(
    bcmolt_onu_tuning_configuration_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_tuning_configuration_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_upgrade_status_id_unpack(
    bcmolt_onu_upgrade_status_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_upgrade_status_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_operation_control_id_unpack(
    bcmolt_operation_control_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_operation_control_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pcie_conn_data_id_unpack(
    bcmolt_pcie_conn_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pcie_conn_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_periodic_ploams_id_unpack(
    bcmolt_periodic_ploams_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_periodic_ploams_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_periodic_standby_pon_monitoring_id_unpack(
    bcmolt_periodic_standby_pon_monitoring_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_periodic_standby_pon_monitoring_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_ploam_filter_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ploam_retransmission_id_unpack(
    bcmolt_ploam_retransmission_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ploam_retransmission_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_policer_action_id_unpack(
    bcmolt_policer_action_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_policer_action_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_policer_ref_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_pon_alloc_sla_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_available_bandwidth_id_unpack(
    bcmolt_pon_available_bandwidth_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_available_bandwidth_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_pon_distance_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_drift_control_id_unpack(
    bcmolt_pon_drift_control_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_drift_control_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_pon_id_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_onu_upgrade_status_id_unpack(
    bcmolt_pon_onu_upgrade_status_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_onu_upgrade_status_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_power_level_id_unpack(
    bcmolt_pon_power_level_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_power_level_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_power_consumption_channel_report_id_unpack(
    bcmolt_power_consumption_channel_report_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_power_consumption_channel_report_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_prbs_checker_config_id_unpack(
    bcmolt_prbs_checker_config_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_prbs_checker_config_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_prbs_generator_config_id_unpack(
    bcmolt_prbs_generator_config_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_prbs_generator_config_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_prbs_status_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_type_id_unpack(
    bcmolt_protection_type_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_type_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_remote_mep_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_request_registration_status_id_unpack(
    bcmolt_request_registration_status_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_request_registration_status_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ring_port_detailed_state_id_unpack(
    bcmolt_ring_port_detailed_state_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ring_port_detailed_state_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_rssi_measurement_result_id_unpack(
    bcmolt_rssi_measurement_result_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_rssi_measurement_result_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_serial_number_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_service_discovery_id_unpack(
    bcmolt_service_discovery_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_service_discovery_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_src_binding_info_id_unpack(
    bcmolt_src_binding_info_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_src_binding_info_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_config_id_unpack(
    bcmolt_stat_alarm_config_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_config_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_soak_config_id_unpack(
    bcmolt_stat_alarm_soak_config_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_soak_config_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_trigger_config_id_unpack(
    bcmolt_stat_alarm_trigger_config_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_trigger_config_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_trigger_config_rate_threshold_id_unpack(
    bcmolt_stat_alarm_trigger_config_rate_threshold_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_trigger_config_rate_threshold_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_trigger_config_rate_range_id_unpack(
    bcmolt_stat_alarm_trigger_config_rate_range_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_trigger_config_rate_range_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_trigger_config_value_threshold_id_unpack(
    bcmolt_stat_alarm_trigger_config_value_threshold_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_trigger_config_value_threshold_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_stat_alarm_trigger_config_none_id_unpack(
    bcmolt_stat_alarm_trigger_config_none_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_stat_alarm_trigger_config_none_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_sw_error_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_system_profile_id_unpack(
    bcmolt_system_profile_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_system_profile_id)num_val;
    return BCMOS_TRUE;
}

bcmos_bool bcmolt_taildrop_params_id_pack(
    bcmolt_taildrop_params_id obj,
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u8(p_buf, (uint8_t)obj);
}

bcmos_bool bcmolt_taildrop_params_id_unpack(
    bcmolt_taildrop_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_taildrop_params_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_queue_ref_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_attachment_point_id_unpack(
    bcmolt_tm_sched_attachment_point_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_attachment_point_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_attachment_point_interface_id_unpack(
    bcmolt_tm_sched_attachment_point_interface_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_attachment_point_interface_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_attachment_point_tm_sched_id_unpack(
    bcmolt_tm_sched_attachment_point_tm_sched_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_attachment_point_tm_sched_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_param_id_unpack(
    bcmolt_tm_sched_param_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_param_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_param_priority_id_unpack(
    bcmolt_tm_sched_param_priority_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_param_priority_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_param_weight_id_unpack(
    bcmolt_tm_sched_param_weight_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_param_weight_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_sched_ref_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_shaping_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_topology_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_topology_map_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_trap_config_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_burst_profile_id_unpack(
    bcmolt_xgpon_burst_profile_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_burst_profile_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_multicast_key_id_unpack(
    bcmolt_xgpon_multicast_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_multicast_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_onu_alarm_indication_control_id_unpack(
    bcmolt_xgpon_onu_alarm_indication_control_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_onu_alarm_indication_control_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_onu_alarm_state_id_unpack(
    bcmolt_xgpon_onu_alarm_state_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_onu_alarm_state_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_onu_alarms_id_unpack(
    bcmolt_xgpon_onu_alarms_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_onu_alarms_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_onu_alarms_thresholds_id_unpack(
    bcmolt_xgpon_onu_alarms_thresholds_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_onu_alarms_thresholds_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_onu_params_id_unpack(
    bcmolt_xgpon_onu_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_onu_params_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_onu_registration_keys_id_unpack(
    bcmolt_xgpon_onu_registration_keys_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_onu_registration_keys_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_xgpon_pon_params_id_unpack(
    bcmolt_xgpon_pon_params_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_xgpon_pon_params_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_xgpon_trx_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_key_id_unpack(
    bcmolt_access_control_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_cfg_data_id_unpack(
    bcmolt_access_control_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_stats_data_id_unpack(
    bcmolt_access_control_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_receive_eth_packet_data_id_unpack(
    bcmolt_access_control_receive_eth_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_receive_eth_packet_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_interfaces_update_data_id_unpack(
    bcmolt_access_control_interfaces_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_interfaces_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_stats_cfg_data_id_unpack(
    bcmolt_access_control_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_stats_alarm_raised_data_id_unpack(
    bcmolt_access_control_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_stats_alarm_cleared_data_id_unpack(
    bcmolt_access_control_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_access_control_auto_cfg_data_id_unpack(
    bcmolt_access_control_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_access_control_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_bal_system_cfg_data_id_unpack(
    bcmolt_bal_system_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_bal_system_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_bal_system_key_id_unpack(
    bcmolt_bal_system_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_bal_system_key_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_device_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_cfg_data_id_unpack(
    bcmolt_device_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_connect_data_id_unpack(
    bcmolt_device_connect_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_connect_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_host_keep_alive_data_id_unpack(
    bcmolt_device_host_keep_alive_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_host_keep_alive_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_set_8021_as_tod_string_data_id_unpack(
    bcmolt_device_set_8021_as_tod_string_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_set_8021_as_tod_string_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_image_transfer_start_data_id_unpack(
    bcmolt_device_image_transfer_start_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_image_transfer_start_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_image_transfer_data_data_id_unpack(
    bcmolt_device_image_transfer_data_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_image_transfer_data_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_run_ddr_test_data_id_unpack(
    bcmolt_device_run_ddr_test_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_run_ddr_test_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_device_ready_data_id_unpack(
    bcmolt_device_device_ready_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_device_ready_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_device_keep_alive_data_id_unpack(
    bcmolt_device_device_keep_alive_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_device_keep_alive_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_connection_failure_data_id_unpack(
    bcmolt_device_connection_failure_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_connection_failure_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_connection_complete_data_id_unpack(
    bcmolt_device_connection_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_connection_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_disconnection_complete_data_id_unpack(
    bcmolt_device_disconnection_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_disconnection_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_sw_error_data_id_unpack(
    bcmolt_device_sw_error_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_sw_error_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_sw_exception_data_id_unpack(
    bcmolt_device_sw_exception_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_sw_exception_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_image_transfer_complete_data_id_unpack(
    bcmolt_device_image_transfer_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_image_transfer_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_ddr_test_complete_data_id_unpack(
    bcmolt_device_ddr_test_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_ddr_test_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_sw_health_check_failure_data_id_unpack(
    bcmolt_device_sw_health_check_failure_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_sw_health_check_failure_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_change_inni_mux_data_id_unpack(
    bcmolt_device_change_inni_mux_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_change_inni_mux_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_inni_mux_configuration_completed_data_id_unpack(
    bcmolt_device_inni_mux_configuration_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_inni_mux_configuration_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_tod_calibration_done_data_id_unpack(
    bcmolt_device_tod_calibration_done_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_tod_calibration_done_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_device_auto_cfg_data_id_unpack(
    bcmolt_device_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_device_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_key_id_unpack(
    bcmolt_erps_interface_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_cfg_data_id_unpack(
    bcmolt_erps_interface_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_set_ring_port_control_data_id_unpack(
    bcmolt_erps_interface_set_ring_port_control_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_set_ring_port_control_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_ring_port_control_data_id_unpack(
    bcmolt_erps_interface_ring_port_control_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_ring_port_control_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_set_intf_opt_data_id_unpack(
    bcmolt_erps_interface_set_intf_opt_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_set_intf_opt_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_port_update_data_id_unpack(
    bcmolt_erps_interface_port_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_port_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_set_intf_opt_complete_data_id_unpack(
    bcmolt_erps_interface_set_intf_opt_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_set_intf_opt_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_port_update_complete_data_id_unpack(
    bcmolt_erps_interface_port_update_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_port_update_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_erps_interface_auto_cfg_data_id_unpack(
    bcmolt_erps_interface_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_erps_interface_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_eth_oam_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_cfg_data_id_unpack(
    bcmolt_eth_oam_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_ccm_event_data_id_unpack(
    bcmolt_eth_oam_ccm_event_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_ccm_event_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_stats_data_id_unpack(
    bcmolt_eth_oam_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_set_mep_state_data_id_unpack(
    bcmolt_eth_oam_set_mep_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_set_mep_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_state_change_data_id_unpack(
    bcmolt_eth_oam_state_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_state_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_stats_cfg_data_id_unpack(
    bcmolt_eth_oam_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_stats_alarm_raised_data_id_unpack(
    bcmolt_eth_oam_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_stats_alarm_cleared_data_id_unpack(
    bcmolt_eth_oam_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_eth_oam_auto_cfg_data_id_unpack(
    bcmolt_eth_oam_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_eth_oam_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_flow_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_flow_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_stats_data_id_unpack(
    bcmolt_flow_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_send_eth_packet_data_id_unpack(
    bcmolt_flow_send_eth_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_send_eth_packet_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_src_binding_update_data_id_unpack(
    bcmolt_flow_src_binding_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_src_binding_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_stats_cfg_data_id_unpack(
    bcmolt_flow_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_stats_alarm_raised_data_id_unpack(
    bcmolt_flow_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_stats_alarm_cleared_data_id_unpack(
    bcmolt_flow_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_flow_auto_cfg_data_id_unpack(
    bcmolt_flow_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_flow_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gpio_key_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_gpio_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_cfg_data_id_unpack(
    bcmolt_group_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_group_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_members_update_data_id_unpack(
    bcmolt_group_members_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_members_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_complete_members_update_data_id_unpack(
    bcmolt_group_complete_members_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_complete_members_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_group_auto_cfg_data_id_unpack(
    bcmolt_group_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_group_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_host_log_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_log_cfg_data_id_unpack(
    bcmolt_host_log_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_log_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_log_file_key_id_unpack(
    bcmolt_host_log_file_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_log_file_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_host_log_file_cfg_data_id_unpack(
    bcmolt_host_log_file_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_host_log_file_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_inband_mgmt_channel_cfg_data_id_unpack(
    bcmolt_inband_mgmt_channel_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_inband_mgmt_channel_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_inband_mgmt_channel_key_id_unpack(
    bcmolt_inband_mgmt_channel_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_inband_mgmt_channel_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_key_id_unpack(
    bcmolt_internal_nni_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_cfg_data_id_unpack(
    bcmolt_internal_nni_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_status_changed_data_id_unpack(
    bcmolt_internal_nni_status_changed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_status_changed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_nni_stats_data_id_unpack(
    bcmolt_internal_nni_nni_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_nni_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_enet_stats_data_id_unpack(
    bcmolt_internal_nni_enet_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_enet_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_packet_captured_data_id_unpack(
    bcmolt_internal_nni_packet_captured_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_packet_captured_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_send_eth_packet_data_id_unpack(
    bcmolt_internal_nni_send_eth_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_send_eth_packet_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_nni_stats_cfg_data_id_unpack(
    bcmolt_internal_nni_nni_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_nni_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_nni_stats_alarm_raised_data_id_unpack(
    bcmolt_internal_nni_nni_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_nni_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_nni_stats_alarm_cleared_data_id_unpack(
    bcmolt_internal_nni_nni_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_nni_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_enet_stats_cfg_data_id_unpack(
    bcmolt_internal_nni_enet_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_enet_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_enet_stats_alarm_raised_data_id_unpack(
    bcmolt_internal_nni_enet_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_enet_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_enet_stats_alarm_cleared_data_id_unpack(
    bcmolt_internal_nni_enet_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_enet_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_internal_nni_auto_cfg_data_id_unpack(
    bcmolt_internal_nni_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_internal_nni_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_key_id_unpack(
    bcmolt_itupon_alloc_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_cfg_data_id_unpack(
    bcmolt_itupon_alloc_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_configuration_completed_data_id_unpack(
    bcmolt_itupon_alloc_configuration_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_configuration_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_get_stats_data_id_unpack(
    bcmolt_itupon_alloc_get_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_get_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_get_alloc_stats_completed_data_id_unpack(
    bcmolt_itupon_alloc_get_alloc_stats_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_get_alloc_stats_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_set_state_data_id_unpack(
    bcmolt_itupon_alloc_set_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_set_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_stats_data_id_unpack(
    bcmolt_itupon_alloc_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_alloc_onu_accumulated_stats_data_id_unpack(
    bcmolt_itupon_alloc_alloc_onu_accumulated_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_alloc_onu_accumulated_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_latency_stats_data_id_unpack(
    bcmolt_itupon_alloc_latency_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_latency_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_stats_cfg_data_id_unpack(
    bcmolt_itupon_alloc_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_stats_alarm_raised_data_id_unpack(
    bcmolt_itupon_alloc_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_stats_alarm_cleared_data_id_unpack(
    bcmolt_itupon_alloc_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_alloc_onu_accumulated_stats_cfg_data_id_unpack(
    bcmolt_itupon_alloc_alloc_onu_accumulated_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_alloc_onu_accumulated_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_alloc_onu_accumulated_stats_alarm_raised_data_id_unpack(
    bcmolt_itupon_alloc_alloc_onu_accumulated_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_alloc_onu_accumulated_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_alloc_onu_accumulated_stats_alarm_cleared_data_id_unpack(
    bcmolt_itupon_alloc_alloc_onu_accumulated_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_alloc_onu_accumulated_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_latency_stats_cfg_data_id_unpack(
    bcmolt_itupon_alloc_latency_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_latency_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_latency_stats_alarm_raised_data_id_unpack(
    bcmolt_itupon_alloc_latency_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_latency_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_latency_stats_alarm_cleared_data_id_unpack(
    bcmolt_itupon_alloc_latency_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_latency_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_alloc_auto_cfg_data_id_unpack(
    bcmolt_itupon_alloc_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_alloc_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_key_id_unpack(
    bcmolt_itupon_gem_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_cfg_data_id_unpack(
    bcmolt_itupon_gem_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_stats_data_id_unpack(
    bcmolt_itupon_gem_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_configuration_completed_data_id_unpack(
    bcmolt_itupon_gem_configuration_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_configuration_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_set_state_data_id_unpack(
    bcmolt_itupon_gem_set_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_set_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_stats_cfg_data_id_unpack(
    bcmolt_itupon_gem_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_stats_alarm_raised_data_id_unpack(
    bcmolt_itupon_gem_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_stats_alarm_cleared_data_id_unpack(
    bcmolt_itupon_gem_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_itupon_gem_auto_cfg_data_id_unpack(
    bcmolt_itupon_gem_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_itupon_gem_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_key_id_unpack(
    bcmolt_l2_mac_table_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_cfg_data_id_unpack(
    bcmolt_l2_mac_table_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_dump_data_id_unpack(
    bcmolt_l2_mac_table_dump_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_dump_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_dump_complete_data_id_unpack(
    bcmolt_l2_mac_table_dump_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_dump_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_network_events_data_id_unpack(
    bcmolt_l2_mac_table_network_events_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_network_events_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_pon_events_data_id_unpack(
    bcmolt_l2_mac_table_pon_events_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_pon_events_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_l2_mac_table_auto_cfg_data_id_unpack(
    bcmolt_l2_mac_table_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_l2_mac_table_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_key_id_unpack(
    bcmolt_lag_interface_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_cfg_data_id_unpack(
    bcmolt_lag_interface_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_stats_data_id_unpack(
    bcmolt_lag_interface_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_members_update_data_id_unpack(
    bcmolt_lag_interface_members_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_members_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_complete_members_update_data_id_unpack(
    bcmolt_lag_interface_complete_members_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_complete_members_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_state_update_data_id_unpack(
    bcmolt_lag_interface_state_update_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_state_update_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_state_updated_data_id_unpack(
    bcmolt_lag_interface_state_updated_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_state_updated_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_lag_health_change_data_id_unpack(
    bcmolt_lag_interface_lag_health_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_lag_health_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_stats_cfg_data_id_unpack(
    bcmolt_lag_interface_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_stats_alarm_raised_data_id_unpack(
    bcmolt_lag_interface_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_stats_alarm_cleared_data_id_unpack(
    bcmolt_lag_interface_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_lag_interface_auto_cfg_data_id_unpack(
    bcmolt_lag_interface_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_lag_interface_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_log_key_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_log_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_log_file_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_log_file_cfg_data_id_unpack(
    bcmolt_log_file_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_log_file_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ngpon2_channel_key_id_unpack(
    bcmolt_ngpon2_channel_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ngpon2_channel_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_ngpon2_channel_cfg_data_id_unpack(
    bcmolt_ngpon2_channel_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_ngpon2_channel_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_key_id_unpack(
    bcmolt_nni_interface_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_state_change_data_id_unpack(
    bcmolt_nni_interface_state_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_state_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_cfg_data_id_unpack(
    bcmolt_nni_interface_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_set_nni_state_data_id_unpack(
    bcmolt_nni_interface_set_nni_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_set_nni_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_stats_data_id_unpack(
    bcmolt_nni_interface_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_link_state_change_data_id_unpack(
    bcmolt_nni_interface_link_state_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_link_state_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_fault_code_change_data_id_unpack(
    bcmolt_nni_interface_fault_code_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_fault_code_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_stats_cfg_data_id_unpack(
    bcmolt_nni_interface_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_stats_alarm_raised_data_id_unpack(
    bcmolt_nni_interface_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_stats_alarm_cleared_data_id_unpack(
    bcmolt_nni_interface_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_nni_interface_auto_cfg_data_id_unpack(
    bcmolt_nni_interface_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_nni_interface_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_olt_key_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_olt_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_olt_bal_failure_data_id_unpack(
    bcmolt_olt_bal_failure_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_olt_bal_failure_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_olt_sw_error_data_id_unpack(
    bcmolt_olt_sw_error_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_olt_sw_error_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_olt_reset_data_id_unpack(
    bcmolt_olt_reset_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_olt_reset_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_olt_auto_cfg_data_id_unpack(
    bcmolt_olt_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_olt_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_key_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_pon_stats_data_id_unpack(
    bcmolt_onu_itu_pon_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_pon_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_set_onu_state_data_id_unpack(
    bcmolt_onu_set_onu_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_set_onu_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_request_registration_data_id_unpack(
    bcmolt_onu_request_registration_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_request_registration_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_change_power_levelling_data_id_unpack(
    bcmolt_onu_change_power_levelling_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_change_power_levelling_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_adjust_tx_wavelength_data_id_unpack(
    bcmolt_onu_adjust_tx_wavelength_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_adjust_tx_wavelength_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_secure_mutual_authentication_data_id_unpack(
    bcmolt_onu_secure_mutual_authentication_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_secure_mutual_authentication_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_tuning_out_data_id_unpack(
    bcmolt_onu_tuning_out_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_tuning_out_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_xgpon_alarm_data_id_unpack(
    bcmolt_onu_xgpon_alarm_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_xgpon_alarm_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_gpon_alarm_data_id_unpack(
    bcmolt_onu_gpon_alarm_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_gpon_alarm_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_dowi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_sfi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_sdi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_dfi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_pqsi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_sufi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_tiwi_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_looci_data_id_unpack(
    bcmolt_onu_looci_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_looci_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_loai_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_dgi_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_pee_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_pst_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_ranging_completed_data_id_unpack(
    bcmolt_onu_ranging_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_ranging_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_activation_completed_data_id_unpack(
    bcmolt_onu_onu_activation_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_activation_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_deactivation_completed_data_id_unpack(
    bcmolt_onu_onu_deactivation_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_deactivation_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_enable_completed_data_id_unpack(
    bcmolt_onu_onu_enable_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_enable_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_disable_completed_data_id_unpack(
    bcmolt_onu_onu_disable_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_disable_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_rssi_measurement_completed_data_id_unpack(
    bcmolt_onu_rssi_measurement_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_rssi_measurement_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_invalid_dbru_report_data_id_unpack(
    bcmolt_onu_invalid_dbru_report_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_invalid_dbru_report_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_key_exchange_completed_data_id_unpack(
    bcmolt_onu_key_exchange_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_key_exchange_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_key_exchange_key_mismatch_data_id_unpack(
    bcmolt_onu_key_exchange_key_mismatch_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_key_exchange_key_mismatch_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_loki_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_memi_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_omci_port_id_configuration_completed_data_id_unpack(
    bcmolt_onu_omci_port_id_configuration_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_omci_port_id_configuration_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_ber_interval_configuration_completed_data_id_unpack(
    bcmolt_onu_ber_interval_configuration_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_ber_interval_configuration_completed_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_err_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_password_authentication_completed_data_id_unpack(
    bcmolt_onu_password_authentication_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_password_authentication_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_key_exchange_unconsecutive_index_data_id_unpack(
    bcmolt_onu_key_exchange_unconsecutive_index_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_key_exchange_unconsecutive_index_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_key_exchange_decrypt_required_data_id_unpack(
    bcmolt_onu_key_exchange_decrypt_required_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_key_exchange_decrypt_required_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_activation_standby_completed_data_id_unpack(
    bcmolt_onu_onu_activation_standby_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_activation_standby_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_power_management_state_change_data_id_unpack(
    bcmolt_onu_power_management_state_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_power_management_state_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_possible_drift_data_id_unpack(
    bcmolt_onu_possible_drift_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_possible_drift_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_registration_id_data_id_unpack(
    bcmolt_onu_registration_id_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_registration_id_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_power_level_report_data_id_unpack(
    bcmolt_onu_power_level_report_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_power_level_report_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_power_consumption_report_data_id_unpack(
    bcmolt_onu_power_consumption_report_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_power_consumption_report_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_secure_mutual_authentication_failure_data_id_unpack(
    bcmolt_onu_secure_mutual_authentication_failure_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_secure_mutual_authentication_failure_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_tuning_out_completed_data_id_unpack(
    bcmolt_onu_onu_tuning_out_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_tuning_out_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_onu_tuning_in_completed_data_id_unpack(
    bcmolt_onu_onu_tuning_in_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_onu_tuning_in_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_tuning_response_data_id_unpack(
    bcmolt_onu_tuning_response_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_tuning_response_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_ploam_packet_data_id_unpack(
    bcmolt_onu_ploam_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_ploam_packet_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_cpu_packets_data_id_unpack(
    bcmolt_onu_cpu_packets_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_cpu_packets_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_cpu_packet_data_id_unpack(
    bcmolt_onu_cpu_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_cpu_packet_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_omci_packet_data_id_unpack(
    bcmolt_onu_omci_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_omci_packet_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_onu_rei_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_state_change_data_id_unpack(
    bcmolt_onu_state_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_state_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_range_value_changed_data_id_unpack(
    bcmolt_onu_range_value_changed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_range_value_changed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_xpon_unknown_ploam_data_id_unpack(
    bcmolt_onu_xpon_unknown_ploam_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_xpon_unknown_ploam_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_trap_ploam_received_data_id_unpack(
    bcmolt_onu_trap_ploam_received_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_trap_ploam_received_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_alloc_onu_accumulated_stats_data_id_unpack(
    bcmolt_onu_itu_alloc_onu_accumulated_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_alloc_onu_accumulated_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_pon_stats_cfg_data_id_unpack(
    bcmolt_onu_itu_pon_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_pon_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_pon_stats_alarm_raised_data_id_unpack(
    bcmolt_onu_itu_pon_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_pon_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_pon_stats_alarm_cleared_data_id_unpack(
    bcmolt_onu_itu_pon_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_pon_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_alloc_onu_accumulated_stats_cfg_data_id_unpack(
    bcmolt_onu_itu_alloc_onu_accumulated_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_alloc_onu_accumulated_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_alloc_onu_accumulated_stats_alarm_raised_data_id_unpack(
    bcmolt_onu_itu_alloc_onu_accumulated_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_alloc_onu_accumulated_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_itu_alloc_onu_accumulated_stats_alarm_cleared_data_id_unpack(
    bcmolt_onu_itu_alloc_onu_accumulated_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_itu_alloc_onu_accumulated_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_onu_auto_cfg_data_id_unpack(
    bcmolt_onu_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_onu_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pbit_to_tc_key_id_unpack(
    bcmolt_pbit_to_tc_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pbit_to_tc_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pbit_to_tc_cfg_data_id_unpack(
    bcmolt_pbit_to_tc_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pbit_to_tc_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_policer_profile_key_id_unpack(
    bcmolt_policer_profile_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_policer_profile_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_policer_profile_cfg_data_id_unpack(
    bcmolt_policer_profile_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_policer_profile_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_key_id_unpack(
    bcmolt_pon_interface_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_cfg_data_id_unpack(
    bcmolt_pon_interface_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_itu_pon_stats_data_id_unpack(
    bcmolt_pon_interface_itu_pon_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_itu_pon_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_ae_stats_data_id_unpack(
    bcmolt_pon_interface_ae_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_ae_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_set_pon_interface_state_data_id_unpack(
    bcmolt_pon_interface_set_pon_interface_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_set_pon_interface_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_set_onu_state_data_id_unpack(
    bcmolt_pon_interface_set_onu_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_set_onu_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_disable_serial_number_data_id_unpack(
    bcmolt_pon_interface_disable_serial_number_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_disable_serial_number_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_run_special_bw_map_data_id_unpack(
    bcmolt_pon_interface_run_special_bw_map_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_run_special_bw_map_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_start_onu_upgrade_data_id_unpack(
    bcmolt_pon_interface_start_onu_upgrade_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_start_onu_upgrade_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_protection_switching_type_c_set_multiple_onu_state_data_id_unpack(
    bcmolt_pon_interface_protection_switching_type_c_set_multiple_onu_state_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_protection_switching_type_c_set_multiple_onu_state_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_protection_switching_apply_rerange_delta_data_id_unpack(
    bcmolt_pon_interface_protection_switching_apply_rerange_delta_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_protection_switching_apply_rerange_delta_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_cpu_packets_data_id_unpack(
    bcmolt_pon_interface_cpu_packets_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_cpu_packets_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_broadcast_ploam_packet_data_id_unpack(
    bcmolt_pon_interface_broadcast_ploam_packet_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_broadcast_ploam_packet_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_state_change_completed_data_id_unpack(
    bcmolt_pon_interface_state_change_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_state_change_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_tod_request_completed_data_id_unpack(
    bcmolt_pon_interface_tod_request_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_tod_request_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_los_data_id_unpack(
    bcmolt_pon_interface_los_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_los_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_protection_switching_traffic_resume_data_id_unpack(
    bcmolt_pon_interface_protection_switching_traffic_resume_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_protection_switching_traffic_resume_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_protection_switching_onus_ranged_data_id_unpack(
    bcmolt_pon_interface_protection_switching_onus_ranged_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_protection_switching_onus_ranged_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_protection_switching_switchover_completed_data_id_unpack(
    bcmolt_pon_interface_protection_switching_switchover_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_protection_switching_switchover_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_standby_pon_monitoring_cycle_completed_data_id_unpack(
    bcmolt_pon_interface_standby_pon_monitoring_cycle_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_standby_pon_monitoring_cycle_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_onu_discovered_data_id_unpack(
    bcmolt_pon_interface_onu_discovered_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_onu_discovered_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_cpu_packets_failure_data_id_unpack(
    bcmolt_pon_interface_cpu_packets_failure_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_cpu_packets_failure_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_activate_all_onus_completed_data_id_unpack(
    bcmolt_pon_interface_activate_all_onus_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_activate_all_onus_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_onu_upgrade_complete_data_id_unpack(
    bcmolt_pon_interface_onu_upgrade_complete_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_onu_upgrade_complete_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_mpcp_timestamp_changed_data_id_unpack(
    bcmolt_pon_interface_mpcp_timestamp_changed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_mpcp_timestamp_changed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_switch_pon_type_data_id_unpack(
    bcmolt_pon_interface_switch_pon_type_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_switch_pon_type_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_switch_pon_type_completed_data_id_unpack(
    bcmolt_pon_interface_switch_pon_type_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_switch_pon_type_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_rogue_detection_tool_data_id_unpack(
    bcmolt_pon_interface_rogue_detection_tool_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_rogue_detection_tool_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_rogue_detection_tool_done_data_id_unpack(
    bcmolt_pon_interface_rogue_detection_tool_done_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_rogue_detection_tool_done_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_onu_upgrade_activate_commit_data_id_unpack(
    bcmolt_pon_interface_onu_upgrade_activate_commit_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_onu_upgrade_activate_commit_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_itu_pon_stats_cfg_data_id_unpack(
    bcmolt_pon_interface_itu_pon_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_itu_pon_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_itu_pon_stats_alarm_raised_data_id_unpack(
    bcmolt_pon_interface_itu_pon_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_itu_pon_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_itu_pon_stats_alarm_cleared_data_id_unpack(
    bcmolt_pon_interface_itu_pon_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_itu_pon_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_ae_stats_cfg_data_id_unpack(
    bcmolt_pon_interface_ae_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_ae_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_ae_stats_alarm_raised_data_id_unpack(
    bcmolt_pon_interface_ae_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_ae_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_ae_stats_alarm_cleared_data_id_unpack(
    bcmolt_pon_interface_ae_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_ae_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_pon_interface_auto_cfg_data_id_unpack(
    bcmolt_pon_interface_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_pon_interface_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_interface_key_id_unpack(
    bcmolt_protection_interface_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_interface_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_interface_cfg_data_id_unpack(
    bcmolt_protection_interface_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_interface_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_interface_protection_switch_completed_data_id_unpack(
    bcmolt_protection_interface_protection_switch_completed_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_interface_protection_switch_completed_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_protection_interface_auto_cfg_data_id_unpack(
    bcmolt_protection_interface_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_protection_interface_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_software_error_key_id_unpack(
    bcmolt_software_error_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_software_error_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_software_error_cfg_data_id_unpack(
    bcmolt_software_error_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_software_error_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_key_id_unpack(
    bcmolt_switch_inni_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_cfg_data_id_unpack(
    bcmolt_switch_inni_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_stats_data_id_unpack(
    bcmolt_switch_inni_stats_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_stats_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_link_state_change_data_id_unpack(
    bcmolt_switch_inni_link_state_change_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_link_state_change_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_stats_cfg_data_id_unpack(
    bcmolt_switch_inni_stats_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_stats_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_stats_alarm_raised_data_id_unpack(
    bcmolt_switch_inni_stats_alarm_raised_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_stats_alarm_raised_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_stats_alarm_cleared_data_id_unpack(
    bcmolt_switch_inni_stats_alarm_cleared_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_stats_alarm_cleared_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_switch_inni_auto_cfg_data_id_unpack(
    bcmolt_switch_inni_auto_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_switch_inni_auto_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tc_to_queue_key_id_unpack(
    bcmolt_tc_to_queue_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tc_to_queue_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tc_to_queue_cfg_data_id_unpack(
    bcmolt_tc_to_queue_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tc_to_queue_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_qmp_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_qmp_cfg_data_id_unpack(
    bcmolt_tm_qmp_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_qmp_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_queue_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_queue_cfg_data_id_unpack(
    bcmolt_tm_queue_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_queue_cfg_data_id)num_val;
    return BCMOS_TRUE;
}

bcmos_bool bcmolt_tm_queue_profile_key_id_pack(
    bcmolt_tm_queue_profile_key_id obj,
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u8(p_buf, (uint8_t)obj);
}

bcmos_bool bcmolt_tm_queue_profile_key_id_unpack(
    bcmolt_tm_queue_profile_key_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_queue_profile_key_id)num_val;
    return BCMOS_TRUE;
}

bcmos_bool bcmolt_tm_queue_profile_cfg_data_id_pack(
    bcmolt_tm_queue_profile_cfg_data_id obj,
    bcmolt_buf *p_buf)
{
    return bcmolt_buf_write_u8(p_buf, (uint8_t)obj);
}

bcmos_bool bcmolt_tm_queue_profile_cfg_data_id_unpack(
    bcmolt_tm_queue_profile_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_queue_profile_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
    ...
    bcmolt_buf *p_buf)
{
    ...
    *p_obj = (bcmolt_tm_sched_key_id)num_val;
    return BCMOS_TRUE;
}
...
bcmos_bool bcmolt_tm_sched_cfg_data_id_unpack(
    bcmolt_tm_sched_cfg_data_id *p_obj,
    bcmolt_buf *p_buf)
{
    uint8_t num_val;
    if (!bcmolt_buf_read_u8(p_buf, &num_val))
    ...
    *p_obj = (bcmolt_tm_sched_cfg_data_id)num_val;
    return BCMOS_TRUE;
}
