...
typedef struct
{
    ...
    bcmolt_nto1_programming_mode nto1_programming_model; /**< nto1 programming model. */
} bcmolt_bal_system_cfg_data;

/* Constants associated with bcmolt_bal_system_cfg_data. */
#define BCMOLT_BAL_SYSTEM_CFG_DATA_PRESENCE_MASK_ALL 0x00000000000000F0ULL
...
typedef struct
{
    ...
    bcmolt_str_32 debug_bas_code; /**< Permission code of BAS features in the device. */
    bcmos_bool debug_bas_enabled; /**< BAS status in the device: enabled or not */
} bcmolt_device_cfg_data;

/* Constants associated with bcmolt_device_cfg_data. */
#define BCMOLT_DEVICE_CFG_DATA_PRESENCE_MASK_ALL 0x000001FFF83F3EFFULL
...
#define BCMOLT_DEVICE_CFG_DATA_DEBUG_BAS_ENABLED_DEFAULT BCMOS_FALSE
...
typedef struct
{
    ...
    bcmolt_bc_fwrd_state bc_forwarding; /**< bc_forwarding. */
...
#define BCMOLT_FLOW_CFG_DATA_PRESENCE_MASK_ALL 0x000000000003FFFFULL
...
#define BCMOLT_FLOW_CFG_DATA_BC_FORWARDING_DEFAULT BCMOLT_BC_FWRD_STATE_ENABLE
...
typedef struct
{
    ...
    uint64_t used_cbr; /**< CBR BW Used units. */
    uint64_t used_guaranteed_above_cbr; /**< Guaranteed BW above CBR Used units. */
    uint64_t used_additional; /**< Additional BW Used units. */
...
#define BCMOLT_ITUPON_ALLOC_ALLOC_ONU_ACCUMULATED_STATS_DATA_PRESENCE_MASK_ALL 0x000000000000003FULL
...
typedef struct
{
    ...
    bcmolt_stat_alarm_config used_cbr; /**< CBR BW Used units. */
    bcmolt_stat_alarm_config used_guaranteed_above_cbr; /**< Guaranteed BW above CBR Used units. */
    bcmolt_stat_alarm_config used_additional; /**< Additional BW Used units. */
...
#define BCMOLT_ITUPON_ALLOC_ALLOC_ONU_ACCUMULATED_STATS_CFG_DATA_PRESENCE_MASK_ALL 0x000000000000003FULL
...
/** Transport message definition for "alloc_onu_accumulated_stats_alarm_raised" group of "itupon_alloc" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_itupon_alloc_key key; /**< Object key. */
...
/** Transport message definition for "alloc_onu_accumulated_stats_alarm_cleared" group of "itupon_alloc" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_itupon_alloc_key key; /**< Object key. */
...
typedef struct
{
    ...
    uint64_t fec_corrected_symbols; /**< fec corrected symbols - bytes */
    ...
    uint64_t fec_corrected_units; /**< fec corrected units - bits, supported for xGPON only */
...
#define BCMOLT_ONU_ITU_ALLOC_ONU_ACCUMULATED_STATS_DATA_PRESENCE_MASK_ALL 0x000000000000003FULL
...
typedef struct
{
    ...
    bcmolt_stat_alarm_config fec_corrected_symbols; /**< fec corrected symbols - bytes */
    ...
    bcmolt_stat_alarm_config fec_corrected_units; /**< fec corrected units - bits, supported for xGPON only */
...
#define BCMOLT_ONU_ITU_ALLOC_ONU_ACCUMULATED_STATS_CFG_DATA_PRESENCE_MASK_ALL 0x000000000000003FULL
...
/** Transport message definition for "itu_alloc_onu_accumulated_stats_alarm_raised" group of "onu" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_onu_key key; /**< Object key. */
...
/** Transport message definition for "itu_alloc_onu_accumulated_stats_alarm_cleared" group of "onu" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_onu_key key; /**< Object key. */
...
/** Transport message definition for "single_request_standby_pon_monitoring" group of "pon_interface" object. */
typedef struct
{
    bcmolt_oper hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "protection_switching_type_c_set_multiple_onu_state" group of "pon_interface" object. */
typedef struct
{
    bcmolt_oper hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "protection_switching_apply_rerange_delta" group of "pon_interface" object. */
typedef struct
{
    bcmolt_oper hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "serial_number_acquisition_cycle_start" group of "pon_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "protection_switching_traffic_resume" group of "pon_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "protection_switching_rerange_failure" group of "pon_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "protection_switching_switchover_completed" group of "pon_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
/** Transport message definition for "standby_pon_monitoring_cycle_completed" group of "pon_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
...
#define BCMOLT_PON_INTERFACE_ROGUE_DETECTION_TOOL_DONE_DATA_PRESENCE_MASK_ALL 0x0000000000000007ULL
...
/** Transport message definition for "protection_switch_completed" group of "protection_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_protection_interface_key key; /**< Object key. */
...
typedef struct
{
    ...
    bcmolt_tm_queue_profile_id profile_id; /**< queue profile. id=0 reserved for cpu, do not use. */
...
#define BCMOLT_TM_QUEUE_CFG_DATA_PROFILE_ID_DEFAULT (bcmolt_tm_queue_profile_id)0U
...
/** tm queue profile: key */
typedef struct
{
    bcmolt_tm_queue_profile_id id; /**< id. */
} bcmolt_tm_queue_profile_key;

/* Constants associated with bcmolt_tm_queue_profile_key. */
#define BCMOLT_TM_QUEUE_PROFILE_KEY_ID_DEFAULT (bcmolt_tm_queue_profile_id)0U

/** tm queue profile: cfg */
typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmolt_config_state state; /**< state. */
    bcmolt_enqueue_algorithm enqueue; /**< default is tail drop */
    bcmolt_taildrop_params taildrop; /**< taildrop. */
} bcmolt_tm_queue_profile_cfg_data;

/* Constants associated with bcmolt_tm_queue_profile_cfg_data. */
#define BCMOLT_TM_QUEUE_PROFILE_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000007ULL
#define BCMOLT_TM_QUEUE_PROFILE_CFG_DATA_STATE_DEFAULT BCMOLT_CONFIG_STATE_NOT_CONFIGURED
#define BCMOLT_TM_QUEUE_PROFILE_CFG_DATA_ENQUEUE_DEFAULT BCMOLT_ENQUEUE_ALGORITHM_TAIL_DROP

/** Transport message definition for "cfg" group of "tm_queue_profile" object. */
typedef struct
{
    bcmolt_cfg hdr; /**< Transport header. */
    bcmolt_tm_queue_profile_key key; /**< Object key. */
    bcmolt_tm_queue_profile_cfg_data data; /**< All properties that must be set by the user. */
} bcmolt_tm_queue_profile_cfg;

/** Multi-object message definition for "cfg" group of "tm_queue_profile" object. */
typedef struct
{
    bcmolt_multi_cfg hdr; /**< Transport header. */
    bcmolt_tm_queue_profile_key key; /**< Object key (can include wildcards). */
    bcmolt_tm_queue_profile_cfg_data filter; /**< Only include responses that match these values. */
    bcmolt_tm_queue_profile_cfg_data request; /**< Responses will include all present fields. */

    bcmos_bool more; /**< BCMOS_TRUE if not all responses were retreived by the last API call. */
    uint16_t num_responses; /**< Number of responses to the last API call. */
    bcmolt_tm_queue_profile_cfg *responses; /**< Responses to the last API call. */

    bcmolt_tm_queue_profile_key next_key; /**< Key iterator (do not set manually). */
} bcmolt_tm_queue_profile_multi_cfg;
