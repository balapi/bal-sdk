...
/**
 * @brief Gets the number of bytes that a multi-object container would occupy on the wire.
 *
 * Does not include the common header (p_msg->p_hdr->p_hdr).
 *
 * @param[in] p_msg  Pointer to the structure.
 * @return The structure size in bytes.
 */
uint32_t bcmolt_access_control_multi_cfg_get_packed_length(
    const bcmolt_access_control_multi_cfg *p_msg);

/**
 * @brief Packs a multi-object container to bytes for transmission on the wire.
 *
 * Assumes that the common header (p_msg->p_hdr->hdr) has already been packed.
 *
 * @param[in]     p_msg  Pointer to the structure to pack.
 * @param[in,out] p_buf  Pointer to the buffer to write to.
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_access_control_multi_cfg_pack(
    const bcmolt_access_control_multi_cfg *p_msg,
    bcmolt_buf *p_buf);

/**
 * @brief Unpacks a multi-object container from bytes as received on the wire.
 *
 * Assumes that the common header has already been unpacked.
 *
 * @param[in,out] p_buf  Pointer to the buffer to read from.
 * @param[in]     p_hdr  The common header that has already been unpacked.
 * @param[in,out] p_msg  Pointer to the structure to unpack. This can be NULL, in which case the message will be dynamically allocated.
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_access_control_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_access_control_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_access_control_multi_stats_get_packed_length(
    const bcmolt_access_control_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_access_control_multi_stats_pack(
    const bcmolt_access_control_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_access_control_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_access_control_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_bal_system_multi_cfg_get_packed_length(
    const bcmolt_bal_system_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_bal_system_multi_cfg_pack(
    const bcmolt_bal_system_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_bal_system_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_bal_system_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_device_multi_cfg_get_packed_length(
    const bcmolt_device_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_device_multi_cfg_pack(
    const bcmolt_device_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_device_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_device_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_erps_interface_multi_cfg_get_packed_length(
    const bcmolt_erps_interface_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_erps_interface_multi_cfg_pack(
    const bcmolt_erps_interface_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_erps_interface_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_erps_interface_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_eth_oam_multi_cfg_get_packed_length(
    const bcmolt_eth_oam_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_eth_oam_multi_cfg_pack(
    const bcmolt_eth_oam_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_eth_oam_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_eth_oam_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_eth_oam_multi_stats_get_packed_length(
    const bcmolt_eth_oam_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_eth_oam_multi_stats_pack(
    const bcmolt_eth_oam_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_eth_oam_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_eth_oam_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_flow_multi_cfg_get_packed_length(
    const bcmolt_flow_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_flow_multi_cfg_pack(
    const bcmolt_flow_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_flow_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_flow_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_flow_multi_stats_get_packed_length(
    const bcmolt_flow_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_flow_multi_stats_pack(
    const bcmolt_flow_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_flow_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_flow_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_gpio_multi_cfg_get_packed_length(
    const bcmolt_gpio_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_gpio_multi_cfg_pack(
    const bcmolt_gpio_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_gpio_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_gpio_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_group_multi_cfg_get_packed_length(
    const bcmolt_group_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_group_multi_cfg_pack(
    const bcmolt_group_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_group_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_group_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_host_log_multi_cfg_get_packed_length(
    const bcmolt_host_log_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_host_log_multi_cfg_pack(
    const bcmolt_host_log_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_host_log_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_host_log_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_host_log_file_multi_cfg_get_packed_length(
    const bcmolt_host_log_file_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_host_log_file_multi_cfg_pack(
    const bcmolt_host_log_file_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_host_log_file_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_host_log_file_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_inband_mgmt_channel_multi_cfg_get_packed_length(
    const bcmolt_inband_mgmt_channel_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_inband_mgmt_channel_multi_cfg_pack(
    const bcmolt_inband_mgmt_channel_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_inband_mgmt_channel_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_inband_mgmt_channel_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_internal_nni_multi_cfg_get_packed_length(
    const bcmolt_internal_nni_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_internal_nni_multi_cfg_pack(
    const bcmolt_internal_nni_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_internal_nni_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_internal_nni_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_internal_nni_multi_nni_stats_get_packed_length(
    const bcmolt_internal_nni_multi_nni_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_internal_nni_multi_nni_stats_pack(
    const bcmolt_internal_nni_multi_nni_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_internal_nni_multi_nni_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_internal_nni_multi_nni_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_internal_nni_multi_enet_stats_get_packed_length(
    const bcmolt_internal_nni_multi_enet_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_internal_nni_multi_enet_stats_pack(
    const bcmolt_internal_nni_multi_enet_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_internal_nni_multi_enet_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_internal_nni_multi_enet_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_itupon_alloc_multi_cfg_get_packed_length(
    const bcmolt_itupon_alloc_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_cfg_pack(
    const bcmolt_itupon_alloc_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_itupon_alloc_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_itupon_alloc_multi_stats_get_packed_length(
    const bcmolt_itupon_alloc_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_stats_pack(
    const bcmolt_itupon_alloc_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_itupon_alloc_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_itupon_alloc_multi_alloc_onu_accumulated_stats_get_packed_length(
    const bcmolt_itupon_alloc_multi_alloc_onu_accumulated_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_alloc_onu_accumulated_stats_pack(
    const bcmolt_itupon_alloc_multi_alloc_onu_accumulated_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_alloc_onu_accumulated_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_itupon_alloc_multi_alloc_onu_accumulated_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_itupon_alloc_multi_latency_stats_get_packed_length(
    const bcmolt_itupon_alloc_multi_latency_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_latency_stats_pack(
    const bcmolt_itupon_alloc_multi_latency_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_alloc_multi_latency_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_itupon_alloc_multi_latency_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_itupon_gem_multi_cfg_get_packed_length(
    const bcmolt_itupon_gem_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_gem_multi_cfg_pack(
    const bcmolt_itupon_gem_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_gem_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_itupon_gem_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_itupon_gem_multi_stats_get_packed_length(
    const bcmolt_itupon_gem_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_gem_multi_stats_pack(
    const bcmolt_itupon_gem_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_itupon_gem_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_itupon_gem_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_l2_mac_table_multi_cfg_get_packed_length(
    const bcmolt_l2_mac_table_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_l2_mac_table_multi_cfg_pack(
    const bcmolt_l2_mac_table_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_l2_mac_table_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_l2_mac_table_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_lag_interface_multi_cfg_get_packed_length(
    const bcmolt_lag_interface_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_lag_interface_multi_cfg_pack(
    const bcmolt_lag_interface_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_lag_interface_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_lag_interface_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_lag_interface_multi_stats_get_packed_length(
    const bcmolt_lag_interface_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_lag_interface_multi_stats_pack(
    const bcmolt_lag_interface_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_lag_interface_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_lag_interface_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_log_multi_cfg_get_packed_length(
    const bcmolt_log_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_log_multi_cfg_pack(
    const bcmolt_log_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_log_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_log_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_log_file_multi_cfg_get_packed_length(
    const bcmolt_log_file_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_log_file_multi_cfg_pack(
    const bcmolt_log_file_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_log_file_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_log_file_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_ngpon2_channel_multi_cfg_get_packed_length(
    const bcmolt_ngpon2_channel_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_ngpon2_channel_multi_cfg_pack(
    const bcmolt_ngpon2_channel_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_ngpon2_channel_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_ngpon2_channel_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_nni_interface_multi_cfg_get_packed_length(
    const bcmolt_nni_interface_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_nni_interface_multi_cfg_pack(
    const bcmolt_nni_interface_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_nni_interface_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_nni_interface_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_nni_interface_multi_stats_get_packed_length(
    const bcmolt_nni_interface_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_nni_interface_multi_stats_pack(
    const bcmolt_nni_interface_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_nni_interface_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_nni_interface_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_olt_multi_cfg_get_packed_length(
    const bcmolt_olt_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_olt_multi_cfg_pack(
    const bcmolt_olt_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_olt_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_olt_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_onu_multi_cfg_get_packed_length(
    const bcmolt_onu_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_onu_multi_cfg_pack(
    const bcmolt_onu_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_onu_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_onu_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_onu_multi_itu_pon_stats_get_packed_length(
    const bcmolt_onu_multi_itu_pon_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_onu_multi_itu_pon_stats_pack(
    const bcmolt_onu_multi_itu_pon_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_onu_multi_itu_pon_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_onu_multi_itu_pon_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_onu_multi_itu_alloc_onu_accumulated_stats_get_packed_length(
    const bcmolt_onu_multi_itu_alloc_onu_accumulated_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_onu_multi_itu_alloc_onu_accumulated_stats_pack(
    const bcmolt_onu_multi_itu_alloc_onu_accumulated_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_onu_multi_itu_alloc_onu_accumulated_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_onu_multi_itu_alloc_onu_accumulated_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_pbit_to_tc_multi_cfg_get_packed_length(
    const bcmolt_pbit_to_tc_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pbit_to_tc_multi_cfg_pack(
    const bcmolt_pbit_to_tc_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pbit_to_tc_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_pbit_to_tc_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_policer_profile_multi_cfg_get_packed_length(
    const bcmolt_policer_profile_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_policer_profile_multi_cfg_pack(
    const bcmolt_policer_profile_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_policer_profile_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_policer_profile_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_pon_interface_multi_cfg_get_packed_length(
    const bcmolt_pon_interface_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pon_interface_multi_cfg_pack(
    const bcmolt_pon_interface_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pon_interface_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_pon_interface_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_pon_interface_multi_itu_pon_stats_get_packed_length(
    const bcmolt_pon_interface_multi_itu_pon_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pon_interface_multi_itu_pon_stats_pack(
    const bcmolt_pon_interface_multi_itu_pon_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pon_interface_multi_itu_pon_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_pon_interface_multi_itu_pon_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_pon_interface_multi_ae_stats_get_packed_length(
    const bcmolt_pon_interface_multi_ae_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pon_interface_multi_ae_stats_pack(
    const bcmolt_pon_interface_multi_ae_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_pon_interface_multi_ae_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_pon_interface_multi_ae_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_protection_interface_multi_cfg_get_packed_length(
    const bcmolt_protection_interface_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_protection_interface_multi_cfg_pack(
    const bcmolt_protection_interface_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_protection_interface_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_protection_interface_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_software_error_multi_cfg_get_packed_length(
    const bcmolt_software_error_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_software_error_multi_cfg_pack(
    const bcmolt_software_error_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_software_error_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_software_error_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_switch_inni_multi_cfg_get_packed_length(
    const bcmolt_switch_inni_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_switch_inni_multi_cfg_pack(
    const bcmolt_switch_inni_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_switch_inni_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_switch_inni_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_switch_inni_multi_stats_get_packed_length(
    const bcmolt_switch_inni_multi_stats *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_switch_inni_multi_stats_pack(
    const bcmolt_switch_inni_multi_stats *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_switch_inni_multi_stats_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_switch_inni_multi_stats **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_tc_to_queue_multi_cfg_get_packed_length(
    const bcmolt_tc_to_queue_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tc_to_queue_multi_cfg_pack(
    const bcmolt_tc_to_queue_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tc_to_queue_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_tc_to_queue_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_tm_qmp_multi_cfg_get_packed_length(
    const bcmolt_tm_qmp_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_qmp_multi_cfg_pack(
    const bcmolt_tm_qmp_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_qmp_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_tm_qmp_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_tm_queue_multi_cfg_get_packed_length(
    const bcmolt_tm_queue_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_queue_multi_cfg_pack(
    const bcmolt_tm_queue_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_queue_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_tm_queue_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_tm_queue_profile_multi_cfg_get_packed_length(
    const bcmolt_tm_queue_profile_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_queue_profile_multi_cfg_pack(
    const bcmolt_tm_queue_profile_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_queue_profile_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_tm_queue_profile_multi_cfg **p_msg);
 ...
 * @return The structure size in bytes.
 */
uint32_t bcmolt_tm_sched_multi_cfg_get_packed_length(
    const bcmolt_tm_sched_multi_cfg *p_msg);
 ...
 * @return Error encountered during the pack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_sched_multi_cfg_pack(
    const bcmolt_tm_sched_multi_cfg *p_msg,
    bcmolt_buf *p_buf);
 ...
 * @return Error encountered during the unpack (BCM_ERR_OK on success).
 */
bcmos_errno bcmolt_tm_sched_multi_cfg_unpack(
    bcmolt_buf *p_buf,
    const bcmolt_msg *p_hdr,
    bcmolt_tm_sched_multi_cfg **p_msg);
